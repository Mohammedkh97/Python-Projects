...
def calculate_frequencies(file_contents):
    ...
    punctuations = '''!()-[]{};:'"\,<>./?@#$%^&*_~'''
    uninteresting_words = ["the", "a", "to", "if", "is", "it", "of", "and", "or", "an", "as", "i", "me", "my",     "we", "our", "ours", "you", "your", "yours", "he", "she", "him", "his", "her", "hers", "its", "they", "them",     "their", "what", "which", "who", "whom", "this", "that", "am", "are", "was", "were", "be", "been", "being",     "have", "has", "had", "do", "does", "did", "but", "at", "by", "with", "from", "here", "when", "where", "how",     "all", "any", "both", "each", "few", "more", "some", "such", "no","on", "nor", "too", "very", "can", "will", "just"]
    """
    ...
    for words in words_list:
        if words not in final_words:
            final_words[words] = 1
        final_words[words]+= myFile.count(words) 
    ...
    for word in words_list:
        if word not in final_words:
            ...
            final_words[word] +=myFile.count(word)     
                    
                          
    #wordcloud
    cloud = wordcloud.WordCloud()
    cloud.generate_from_frequencies(final_words)
